...
class LargeNew(Resource):
    ...
    #     return render_template('index.html', prediction_text='Employee Salary should be $ {}'.format(output1))
        # return render_template('index.html', prediction_text='Predicted value be $ {}'.format(emp))
